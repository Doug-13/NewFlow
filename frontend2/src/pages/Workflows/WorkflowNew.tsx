    ...
    >
      <Row gutter={[12, 12]}>
        <Col xs={24} md={12}>
          ...
          <Select mode="multiple" style={{ width: '100%' }} placeholder="Todos os usuários"
        ...
        <Col xs={24} md={12}>
          ...
          <Select mode="multiple" style={{ width: '100%' }} placeholder="Todos os grupos"
        ...
        <Col xs={24} md={8}>
          ...
          <Select mode="multiple" style={{ width: '100%' }} placeholder="Todas as unidades"
        ...
        <Col xs={24} md={8}>
          ...
          <Select mode="multiple" style={{ width: '100%' }} placeholder="Todas as áreas"
        ...
        <Col xs={24} md={8}>
          ...
          <Select mode="multiple" style={{ width: '100%' }} placeholder="Todas as disciplinas"
        ...
        <Col xs={24} md={12}>
          ...
          <Select mode="multiple" style={{ width: '100%' }} placeholder="Todas as funções"
...
export function WorkflowNewPage({
  ...
  const handleSubmit = (values: WorkflowNewFormValues) => {
    ...
    message.success('Workflow criado. Agora você pode modelar o BPMN.')
    ...
    >
      <Space style={{ marginBottom: 20 }}>
        ...
        <div>
          ...
          <Text type="secondary">
            Crie o rascunho do fluxo e siga para o modelador BPMN.
          </Text>
        </div>
      </Space>
      ...
      <Alert
        ...
        description="Nesta etapa você cria apenas os dados principais. O desenho das etapas, conexões, gateways e eventos será feito no editor BPMN."
      />
                ...
                <Card bordered={false} style={{ borderRadius: 20 }} title="Dados gerais do workflow">
                  ...
                  <Space style={{ marginTop: 8 }}>
                    <Button type="primary" htmlType="submit" icon={<FileAddOutlined />}>
                      Criar e abrir no BPMN
                    </Button>
                    <Button onClick={() => { if (embedded) { onCancel?.(); return } navigate('/workflows') }}>
                      Cancelar
                    </Button>
                  </Space>
                </Card>
                ...
                <Card bordered={false} style={{ borderRadius: 20, marginTop: 16 }}>
                  <Space align="start">
                    ...
                    <div>
                      ...
                      <div><Text type="secondary">Criar rascunho → modelar BPMN → revisar na tela de detalhes.</Text></div>
                    </div>
                  </Space>
                </Card>
              </Form>
