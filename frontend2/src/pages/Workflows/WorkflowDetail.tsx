...
export function WorkflowDetailPage({
  ...
  const legacySteps = useMemo<LegacyStepViewModel[]>(() => {
    const rawSteps = ((workflow as WorkflowWithLegacySteps | null)?.steps ??
      []) as unknown[]
    ...
    return rawSteps
      ...
      .slice()
      .sort((a: LegacyStepViewModel, b: LegacyStepViewModel) => {
      ...
      >
        <Space>
          ...
          <div>
            ...
            <Text type="secondary">
              Resumo do workflow e acesso ao modelador BPMN.
            </Text>
          </div>
        </Space>
              ...
              children: (
                <div style={{ paddingTop: 8 }}>
                  <Alert
                    ...
                    description="A edição estrutural do processo agora fica concentrada na tela de edição BPMN, evitando duplicidade entre formulários manuais e o diagrama."
                  />
              ...
              children: (
                <div style={{ paddingTop: 8 }}>
                  {legacySteps.length === 0 ? (
                    <Empty description="As etapas agora são definidas principalmente no BPMN" />
                  ) : (
                    <List
                      itemLayout="vertical"
                      ...
                      renderItem={(step: LegacyStepViewModel) => (
                        <List.Item
                          key={step.id || `${step.orderIndex}-${step.name}`}
                        >
                  ...
                  <Space direction="vertical" size={12}>
                    <Card bordered={false} style={{ borderRadius: 16 }}>
                      <Space>
                        ...
                        <div>
                          <Text strong>Editar no BPMN</Text>
                          <div>
                            <Text type="secondary">
                              Abra o modelador principal para ajustar eventos, gateways,
                              fluxos e atividades.
                            </Text>
                          </div>
                        </div>
                    ...
                    <Card bordered={false} style={{ borderRadius: 16 }}>
                      <Space>
                        ...
                        <div>
                          ...
                          <div>
                            <Text type="secondary">
                              Use esta tela para inspeção. Use a tela de edição para mudanças estruturais.
                            </Text>
                          </div>
                        </div>
                      </Space>
