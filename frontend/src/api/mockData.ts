...
export const MOCK_DOCUMENT_INSTANCES = [
  {
    ...
    workflowId: 'wf-1',
    currentStepName: 'Revisão Jurídica',
    currentStepOrderIndex: 2,
    responsibleId: 'user-1',
    responsibleName: 'Carlos Mendes',
    createdById: 'user-2',
    createdByName: 'Fernanda Oliveira',
  ...
  },
  {
    ...
    documentTypeName: 'Contrato',
    workflowId: 'wf-1',
    currentStepName: 'Aprovação Gerencial',
    currentStepOrderIndex: 3,
    responsibleId: 'user-3',
    responsibleName: 'Ricardo Alves',
    createdById: 'user-4',
    createdByName: 'Ana Paula Lima',
  ...
  },
  {
    ...
    documentTypeName: 'Contrato',
    workflowId: 'wf-1',
    currentStepName: 'Solicitação',
    currentStepOrderIndex: 0,
    responsibleId: 'user-1',
    responsibleName: 'Carlos Mendes',
    createdById: 'user-1',
  ...
  },
  {
    ...
    responsibleName: 'Fernanda Oliveira',
    createdById: 'user-2',
    createdByName: 'Fernanda Oliveira',
...
export const MOCK_TASKS = [
  {
    ...
    documentTitle: 'Contrato de Manutenção de TI - Infra Corp',
    documentCode: 'CTR-2024-0001',
    stepName: 'Revisão Jurídica',
    stepOrderIndex: 2,
  ...
  },
  {
    id: 'task-2',
    tenantId: 'tenant-1',
    documentInstanceId: 'doc-2',
    documentTitle: 'Contrato de Consultoria Financeira - Deloitte',
    documentCode: 'CTR-2024-0002',
    stepName: 'Aprovação Gerencial',
    stepOrderIndex: 3,
    assignedUserId: 'user-3',
    assignedUserName: 'Ricardo Alves',
    status: 'pending',
    allowedActions: ['approve', 'cancel'],
    dueDate: '2024-11-07T23:59:00Z',
    ...
    steps: [
      {
        id: 'step-1',
        name: 'Solicitação',
        description: 'Abertura e preenchimento inicial',
        orderIndex: 0,
        isInitial: true,
        isFinal: false,
        slaHours: 8,
        ...
        responsibles: [{ name: 'Solicitante' }],
        metadata: [
          { name: 'supplier', label: 'Fornecedor', type: 'text', required: true, multiple: false, options: [] },
          { name: 'estimated_value', label: 'Valor Estimado', type: 'currency', required: true, multiple: false, options: [] },
          { name: 'contract_type', label: 'Tipo de Contrato', type: 'select', required: true, multiple: false, options: ['Prestação de Serviços', 'Fornecimento', 'Locação', 'NDA'] },
        ],
        transitions: [{ toStepOrderIndex: 1, triggerAction: 'submit' }],
      },
      {
        id: 'step-2',
        name: 'Análise Inicial',
        description: 'Validação dos dados',
        orderIndex: 1,
        isInitial: false,
        isFinal: false,
        slaHours: 16,
        ...
        responsibles: [{ name: 'Analista de Compras' }],
        metadata: [],
        transitions: [
          { toStepOrderIndex: 2, triggerAction: 'approve' },
          { toStepOrderIndex: 0, triggerAction: 'return' },
        ],
      },
      {
        id: 'step-3',
        ...
        receivesNotification: true,
        requiredNotification: true,
        responsibles: [{ name: 'Advogado Sênior' }],
        metadata: [
          { name: 'legal_risk', label: 'Risco Jurídico', type: 'select', required: true, multiple: false, options: ['Baixo', 'Médio', 'Alto', 'Crítico'] },
        ],
        transitions: [
          { toStepOrderIndex: 3, triggerAction: 'approve' },
          { toStepOrderIndex: 0, triggerAction: 'return' },
        ],
      },
      {
        ...
        receivesNotification: true,
        requiredNotification: true,
        responsibles: [{ name: 'Gerente de Compras' }],
        metadata: [],
        transitions: [{ toStepOrderIndex: 4, triggerAction: 'approve' }],
      },
      {
        id: 'step-5',
        name: 'Publicação',
        description: 'Publicação e arquivamento',
        orderIndex: 4,
        isInitial: false,
        isFinal: true,
        slaHours: null,
...
export const MOCK_ORGANIZATION_ROLES = [
  ...
  { id: 'role-2', tenantId: 'tenant-1', name: 'Analista de Compras', description: '', isActive: true, createdAt: '2024-01-10T08:00:00Z' },
  { id: 'role-3', tenantId: 'tenant-1', name: 'Gerente de Compras', description: '', isActive: true, createdAt: '2024-01-10T08:00:00Z' },
  { id: 'role-4', tenantId: 'tenant-1', name: 'Controller', description: '', isActive: true, createdAt: '2024-01-10T08:00:00Z' },
  { id: 'role-5', tenantId: 'tenant-1', name: 'HRBP', description: '', isActive: true, createdAt: '2024-01-10T08:00:00Z' },
]
