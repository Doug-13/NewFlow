...
// ─────────────────────────────────────────────────────────────────────────────
// Paleta de cores — agora usada no modal, não mais na toolbar do editor
// ─────────────────────────────────────────────────────────────────────────────
...
export function BpmnEditor({
  ...
  useEffect(() => {
    if (renameRef) {
      renameRef.current = renameElement
    }

    if (colorRef) {
      colorRef.current = setElementColor
    }
    ...
    >
      ...
      {error ? (
        <Alert
          type="error"
          showIcon
          message="Falha ao carregar BPMN"
          description={error}
      ...
      <div style={{ marginTop: 12 }}>
        <Text type="secondary">
          Dica: clique para selecionar e dê duplo clique para abrir o modal de configuração.
        </Text>
      </div>
    </Card>
  )
